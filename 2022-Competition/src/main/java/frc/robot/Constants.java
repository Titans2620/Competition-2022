...
public final class Constants {
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(35);
    ...
    public static final double FEEDSPEED = .35;
    public static final double SHOOTERSPEED = .65;
